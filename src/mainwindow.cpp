...
void MainWindow::setupUI()
{
    ...
    actionSelectionMode = new QAction(this);
    //actionSelectionMode->setIcon(QIcon":/Images/mouse.png");
    actionSelectionMode->setObjectName(QString::fromUtf8("actionSelectionMode"));
    actionSelectionMode->setCheckable(true);
    Shapes_Connectors->addAction(actionSelectionMode);
    ...
    mainToolBar->addAction(actionSelectionMode);
